...
<div class="row justify-content-center">
    <div class="col-md-7 col-lg-6">
        <div class="card shadow-lg p-4">
            <h3 class="card-title text-center mb-4 text-pink-custom">Yeni Üyelik Oluştur</h3>
            
            <form action="index.php?sayfa=kayit" method="POST">
                
                <div class="mb-3">
                    <label for="reg_username" class="form-label">Kullanıcı Adı</label>
                    <input type="text" class="form-control" id="reg_username" name="username" value="<?php echo htmlspecialchars($kullanici_adi_value); ?>" required>
                </div>
                
                <div class="mb-3">
                    <label for="reg_email" class="form-label">E-posta Adresi</label>
                    <input type="email" class="form-control" id="reg_email" name="email" value="<?php echo htmlspecialchars($email_value); ?>" required>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="password" class="form-control" id="reg_password_repeat" name="password_repeat" required>
                </div>
                ...
                <p class="text-center">Zaten hesabın var mı? <a href="index.php?sayfa=giris" class="text-pink-custom fw-bold">Giriş Yap</a></p>
            </form>
        </div>
    </div>
</div>
