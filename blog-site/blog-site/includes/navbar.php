    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="index.php?kategori=sac">Saç</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="index.php?kategori=cilt">Cilt</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="index.php?kategori=makyaj">Makyaj</a>
                </li>
